...
use aeron_rs::concurrent::ring_buffer::ManyToOneRingBuffer;
use aeron_rs::concurrent::broadcast::BroadcastTransmitter;
use aeron_rs::concurrent::strategies::SleepingIdleStrategy;
...
#[derive(Parser, Debug)]
#[command(name = "aeron_ipc_test")]
#[command(about = "Aeron IPC performance test")]
struct Args {
    ...
    #[arg(long, default_value = "ipc:///test")]
    channel: String,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Aeron IPC Performance Test");
